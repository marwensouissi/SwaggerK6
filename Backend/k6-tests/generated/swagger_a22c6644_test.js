...
const dzs = post_abstract_with_payload({
  url: `https://dev-itona.xyz:443/api/device`,
  token: token,
  tag: "dzs",
  job: "dzs",
    payload: {"label": "Room 234 Sensor", "name": "radomString(12)", "type": "Temperature Sensor"}
});
console.log('🧪 dzs response:', JSON.stringify(dzs.data));
