...
const credentialsData = new SharedArray('device_credentials', () => {
    return [
        { credentialsId: "Hq8mxaPkKRhkTwVGa03q" },        { credentialsId: "OVfq2OGLnIRH5oUotBE7" },        { credentialsId: "S8DJsZHY8glvKZLUGDfO" },        { credentialsId: "2O35RHtQ7HAXJ8kFjsVK" },        { credentialsId: "TdD8OjDdxkvqP9MOdPJM" },        { credentialsId: "ssipSSW7pqk1rHhEtIZ5" },        { credentialsId: "UDPtZVE56bsnQJEt7ewZ" },        { credentialsId: "cGyD74RnHwDnYLQIDYzX" },        { credentialsId: "uyDaJY2DbXBxlhXKvMUn" },        { credentialsId: "v5DOPllOxgiBk0ujUHhX" }    ];
});
