...
const raz = post_abstract_with_payload({
  url: `https://dev-itona.xyz:443/api/device`,
  token: token,
  tag: "raz",
  job: "raz",
    payload: {"label": "Room 234 Sensor", "name": randomString(14), "type": "Temperature Sensor"}
});
console.log('🧪 raz response:', JSON.stringify(raz.data));
