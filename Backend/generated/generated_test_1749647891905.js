...
url: `https://dev-itona.xyz:443/api/asset`,
        ...
        tag: "test",
        job: "test",
          payload: {"label": "NY Building", "name": "Empire State Building", "type": "Building"}
      });
      const de = get_abstract_without_payload({
        url: `https://dev-itona.xyz:443/api/asset/info/${test.data.id.id}`,
        token: token,
        tag: "de",
        job: "de"
      });
      const cc = get_abstract_without_payload({
        url: `https://dev-itona.xyz:443/api/asset/types`,
        token: token,
        tag: "cc",
        job: "cc"
      });
