...
const devicepost = post_abstract_with_payload({
url: `https://dev-itona.xyz:443/api/device`,
      ...
      const getdevice = get_abstract_without_payload({
        url: `https://dev-itona.xyz:443/api/device/${devicepost.data.id.id}`,
        token: token,
        tag: "getdevice",
        job: "getdevice"
      });
      const deletedevice = delete_abstract_without_payload({
        url: `https://dev-itona.xyz:443/api/device/${devicepost.data.id.id}`,
        token: token,
        tag: "deletedevice",
        job: "deletedevice"
