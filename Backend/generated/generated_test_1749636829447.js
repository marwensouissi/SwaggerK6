...
export let options = {
stages: [
    { duration: '60s', target: 2 },    { duration: '30s', target: 1 }]
};
...
const zst = post_abstract_with_payload({
url: `https://dev-itona.xyz:443/api/cameraDevice`,
        token: token,
        tag: "zst",
        job: "zst",
          payload: {"label": "Room 234 Sensor", "name": randomString(15), "type": "Temperature Sensor"}
      });
}