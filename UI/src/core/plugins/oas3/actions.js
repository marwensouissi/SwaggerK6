...
export const REMOVE_API_ENTRY = "REMOVE_API_ENTRY";
export const SET_REQUEST_FUNCTION_NAME = "SET_REQUEST_FUNCTION_NAME";
export const SET_REQUEST_FUNCTION_PARAMS = "SET_REQUEST_FUNCTION_PARAMS"
...
export function removeApiEntry(path, method) {
  return {
    type: REMOVE_API_ENTRY,
    payload: { path, method }
  }
}
export const setRequestFunctionName = ({ path, method, functionName }) => ({
  type: SET_REQUEST_FUNCTION_NAME,
  payload: {
    pathMethod: [path, method],
    functionName
  }
})
export function setRequestFunctionParams({ pathMethod, params }) {
  return {
    type: SET_REQUEST_FUNCTION_PARAMS,
    payload: { pathMethod, params }
  }
}
