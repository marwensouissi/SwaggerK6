  ...
  it("should render a Swagger2 `get` method, but not a `trace` or `foo` method", function(){
    ...
    let props = {
      ...
      specSelectors: {
        ...
        validOperationMethods() { return ["get", "put", "post", "delete","mqtt", "options", "head", "patch"] },
        taggedOperations() {
          return fromJS({
          "default": {
            "operations": [
  ...
  it("should render an OAS3 `get` and `trace` method, but not a `foo` method", function(){
    ...
    let props = {
      ...
      specSelectors: {
        isOAS3() { return true },
        url() { return "https://petstore.swagger.io/v2/swagger.json" },
        validOperationMethods() { return ["get", "put", "post", "delete","mqtt", "options", "head", "patch", "trace"] },
        taggedOperations() {
          return fromJS({
          "default": {
            "operations": [
