...
export default function workflow() {
    ...
    //************* CREATE or EDIT or COPY workflow (POST request) *********************//
    ...
    const notifID = post_notification_response.data.id.id; // Récupérer l'ID de la notification créée
    ...
    console.log("delete workflow :", delete_notification_response); // Journaliser la réponse
    sleep(0.5);
